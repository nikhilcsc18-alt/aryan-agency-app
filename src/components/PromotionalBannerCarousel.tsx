...
export const PromotionalBannerCarousel: React.FC<PromotionalBannerCarouselProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className={`relative w-full min-h-[190px] sm:min-h-[220px] md:min-h-[250px] lg:min-h-[270px] bg-gradient-to-r ${currentBanner.bgGradient} flex items-center transition-all duration-500 overflow-hidden`}>
        ...
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="w-full h-full object-cover object-center opacity-35 mix-blend-luminosity scale-105 transition-transform duration-700"
          />
        ...
        <div className="relative z-10 w-full px-5 sm:px-8 py-5 md:py-6 flex flex-col justify-between max-w-2xl text-white">
          ...
          <div className="mt-3.5 sm:mt-4 flex items-center flex-wrap gap-2.5">
            {currentBanner.targetCategory && onSelectCategory && (
              <button
                type="button"
              ...
              >
                <span>{currentBanner.ctaText || `Browse ${currentBanner.targetCategory}`}</span>
        ...
        {/* Right side floating FMCG decorative badge (desktop) */}
