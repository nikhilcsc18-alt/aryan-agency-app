...
export const Header: React.FC<HeaderProps> = ({
  ...
  const renderDropdown = () => (
    <div 
      className="absolute right-0 mt-2 w-72 sm:w-80 bg-white rounded-lg shadow-xl border border-slate-200 py-2 z-50 text-slate-800 animate-in fade-in zoom-in-95 duration-100"
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="md:hidden flex items-center justify-between h-14">
          ...
          <div className="flex items-center space-x-1.5 shrink-0">
            ...
            {/* Quick Punch Order Button */}
            <button
              id="mobile-header-punch-btn"
              onClick={onOpenNewOrder}
              className="h-9 px-2.5 rounded-lg bg-[#2563eb] text-white text-xs font-bold flex items-center space-x-1 active:scale-95 shadow-sm transition-transform"
              title="Punch Order"
            >
